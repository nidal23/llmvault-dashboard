    ...
    Tables: {
      ...
      prompts: {
        Row: {
          ...
          preferred_platforms: string[] | null; // NEW FIELD
        };
        Insert: {
          id?: string;
          title: string;
        ...
        Relationships: [
          {
            ...
            columns: ["folder_id"];
            isOneToOne: false;
            referencedRelation: "prompt_folders";
            referencedColumns: ["id"];
          }
        ];
      };
      ...
      prompt_folders: {
        ...
        Relationships: [
          {
            foreignKeyName: "prompt_folders_parent_id_fkey";
            columns: ["parent_id"];
            isOneToOne: false;
            referencedRelation: "prompt_folders";
            referencedColumns: ["id"];
...
export type CreatePromptInput = Omit<
  PromptInsert,
  "id" | "user_id" | "created_at" | "updated_at" | "usage" | "is_favorite"
> & {
  is_favorite?: boolean;
};

export type UpdatePromptInput = Partial<
  Omit<Prompt, "id" | "user_id" | "created_at" | "updated_at">
>;
// Add additional types for UI needs
export function safeParsePlatforms(
  platforms: Json | null
): PlatformWithColor[] {
  if (!platforms) return [];
...
export interface PromptFolderWithCount extends PromptFolder {
  promptCount?: number;
  children?: PromptFolderWithCount[];
}

// Enhanced Prompt type with folder info
